...
// * @author summerao
// */
//public class RedisClusterClientFactory_back implements FactoryBean<RedisClusterInterface>, InitializingBean, DisposableBean {
//
//    private final int CONNECTION_TIMEOUT = 2000;//连接超时（默认2000ms）
//    private static Logger logger = LoggerFactory.getLogger(RedisClusterClientFactory_back.class);
