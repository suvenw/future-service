...
public class RedisClusterConfigSettings {
    ...
    /** redis 默认使用单机模式,启用集群配置,从RedisClusterAutoConfiguration初始化为集群模式, **/
    ...
    public static class RedisClientSettings{
        ...
        private String model = RedisClientModeEnum.CLUSTER.getValue();
