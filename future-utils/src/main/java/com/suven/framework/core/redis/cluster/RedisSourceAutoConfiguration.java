...
//@Configuration
//@ConditionalOnClass({ RedisClientFactory.class, RedisClusterInterface.class})
//@AutoConfigureAfter({RedisAutoConfiguration.class, RedisClientConfigSettings.class})
//@EnableConfigurationProperties({RedisClientConfigSettings.class})
//@ConditionalOnProperty(name = GlobalConfigConstants.REDIS_AUTO_CONFIG_ONE_ENABLED,  matchIfMissing = true)
...
//
//   @Autowired
//   private  RedisClientConfigSettings redisConfigSettings;
//
//
