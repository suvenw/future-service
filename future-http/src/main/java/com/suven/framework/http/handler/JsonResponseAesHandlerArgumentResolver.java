...
public class JsonResponseAesHandlerArgumentResolver extends AbstractHandlerArgumentResolver<OutputAesResponse> {
    ...
    protected Object onResolve(MethodParameter parameter,
        ...
        return OutputAesResponse.getInstance(response);
    }
