...
import com.suven.framework.http.data.vo.RequestHeaderParserVo;
...
public class JsonHandlerInterceptorAdapter extends BaseHandlerInterceptorAdapter
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(null != systemParamSettings && systemParamSettings.isHeaderToken()){
            ...
            message = RequestHeaderParserVo.build().parseHeader(headerInfoMap, HttpRequestPostMessage.class);
        }else {
    ...
    private Map postJson(final HttpServletRequest request){
        try {
     ...
     * @param request
     */
    private void  getTokenByHeader(HttpRequestPostMessage message,HttpServletRequest request) throws Exception {
        if(StringUtils.isEmpty(message.getAccessToken()) ){
            Map<String, Object> headerMap =  getHeadersInfo(request);
            HttpRequestPostMessage header = JsonParse.parseFrom(headerMap, HttpRequestPostMessage.class);
            if(header != null){
                message.setAccessToken(header.getAccessToken());
            }
        }
    }
