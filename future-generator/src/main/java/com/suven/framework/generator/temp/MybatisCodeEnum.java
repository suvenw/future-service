...
public enum MybatisCodeEnum implements CreateCodeEnum{
    ...
    //rpc
    RPC_MODEL(1,"jdbc_cache_model.java.vm","/entity/",".java",1),
    ...
    API_DTO_REQUEST(2,"jdbc_cache_request_dto.java.vm","/dto/request/","RequestDto.java",1),
    API_DTO_RESPONSE(2,"jdbc_cache_response_dto.java.vm","/dto/response/","ResponseDto.java",1),

    //接口api
    HTTP_VO_REQUEST(2,"jdbc_cache_request_vo.java.vm","/vo/request/","RequestVo.java",1),
    HTTP_VO_RESPONSE(2,"jdbc_cache_response_vo.java.vm","/vo/response/","ResponseVo.java",1),

    //后台sys api
    HTTP_VO_REQUEST_ADD(2,"jdbc_cache_request_add_vo.java.vm","/vo/request/","AddRequestVo.java",1),
    HTTP_VO_REQUEST_QUERY(2,"jdbc_cache_request_query_vo.java.vm","/vo/request/","QueryRequestVo.java",1),
    HTTP_VO_RESPONSE_SHOW(2,"jdbc_cache_response_show_vo.java.vm","/vo/response/","ShowResponseVo.java",1),
