...
public enum MybatisCodeEnum implements CreateCodeEnum{
    ...
    //rpc
    RPC_MODEL(1,"mybatis_base_model.java.vm","/entity/",".java",1),
    RPC_MAPPER(1,"mybatis_mapper.java.vm","/mapper/","Mapper.java"),
    RPC_MAPPER_XML(1,"mybatis_mapper.xml.vm","/mapper/","Mapper.xml"),
    RPC_CACHE_DAO(1,"mybatis_cache_dao.java.vm","/dao/","Dao.java"),
    RPC_ENTITY_DAO(1,"mybatis_entity_dao.java.vm","/dao/","Dao.java"),
    ...
    //接口api
    HTTP_VO_REQUEST(2,"mybatis_base_request_vo.java.vm","/vo/request/","RequestVo.java",1),
    HTTP_VO_RESPONSE(2,"mybatis_base_response_vo.java.vm","/vo/response/","ResponseVo.java",1),

    //后台sys api
    HTTP_VO_REQUEST_ADD(2,"mybatis_base_request_add_vo.java.vm","/vo/request/","AddRequestVo.java",1),
    ...
    //http service项目
    HTTP_FACADE(3,"mybatis_base_facade.java.vm","/facade/","Facade.java"),
