...
public class ApacheHttpFutureProxy extends AbstractFutureProxy<HttpResponse,ApacheFutureCallback>
{

    public static ApacheHttpFutureProxy build(){
        CompletableFuture future =  new  CompletableFuture();
        FutureCallbackProxy  futureCallbackProxy = new ApacheFutureCallback(future);
        return new ApacheHttpFutureProxy(future,futureCallbackProxy);
    }


    public ApacheHttpFutureProxy(CompletableFuture<HttpClientResponse> future, FutureCallbackProxy futureCallbackProxy ){
