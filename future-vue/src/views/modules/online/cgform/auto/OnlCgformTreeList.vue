  ...
  export default {
    ...
    methods: {
      ...
      configInfohandler(res){
        ...
        this.formTemplate = res.data.formTemplate
        this.description = res.data.description
        this.currentTableName = res.data.currentTableName
        this.pidField = res.data.pidField
        this.hasChildrenField = res.data.hasChildrenField
        this.textField = res.data.textField
        //自定义按钮
