      ...
      <a-card :bordered="false">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="备注">
            <a-textarea placeholder="请输入备注" v-decorator="['remarks', {'initialValue':''}]"/>
          </a-form-item>
        </a-form>
  ...
  export default {
    ...
    methods: {
      ...
      setThisExpandedKeys(node) {
        if (node.children && node.children.length > 0) {
          ...
          for (let a = 0; a < node.children.length; a++) {
            node.children[a].parentId = "" + node.children[a].parentId
      ...
      batchDel: function () {
        ...
        if (this.checkedKeys.length <= 0) {
          ...
          this.$confirm({
            ...
            onOk: function () {
              deleteAction(that.url.deleteBatch, {idList: ids}).then((res) => {
                if (res.code ==0) {
      ...
      setValuesToForm(record) {
        ...
        this.form.setFieldsValue(pick(record, 'departName', 'orgCode', 'sort', 'mobile', 'fax', 'address', 'remarks'))
      },
