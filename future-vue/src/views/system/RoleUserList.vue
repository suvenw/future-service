  ...
  export default {
      ...
      return {
        ...
        columns2: [{
          ...
          url: {
            ...
            delete2: '/sys/user/deleteUserRoleBatch',
    ...
    methods: {
      ...
      handleDelete2: function(id) {
        ...
        var that = this
        deleteAction(that.url.delete2, { roleId: this.currentRoleId, idList: id }).then((res) => {
          if (res.code ==0) {
      ...
      batchDel2: function() {
        ...
        if (this.selectedRowKeys2.length <= 0) {
          ...
          for (var a = 0; a < this.selectedRowKeys2.length; a++) {
            ids += this.selectedRowKeys2[a] + String.fromCharCode(7);
          }
          var that = this
          ...
          this.$confirm({
            ...
            content: '是否删除选中数据?',
            onOk: function() {
              deleteAction(that.url.deleteBatch2, { roleId: that.currentRoleId, idList: ids }).then((res) => {
                if (res.code ==0) {
                  that.$message.success(res.msg)
                  that.loadData2()
      ...
      selectOK(data) {
        ...
        for (var a = 0; a < data.length; a++) {
          ids += data[a] + String.fromCharCode(7); 
        }
        params.append('roleId',this.currentRoleId)
