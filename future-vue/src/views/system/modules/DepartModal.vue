  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
          ...
          this.$nextTick(() => {
            this.form.setFieldsValue(pick(this.model,'departName','departNameEn','departNameAbbr','sort','description','orgType','orgCode','mobile','fax','address','remarks','status','delFlag'))
          });
      },
      close () {
        this.$emit('close');
