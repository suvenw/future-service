  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="原密码" :labelCol="labelCol" :wrapperCol="wrapperCol" hasFeedback >
          <a-input type="oldpassword" placeholder="请输入原密码" v-decorator="[ 'oldpassword', validatorRules.oldpassword]" />
        </a-form-item>
