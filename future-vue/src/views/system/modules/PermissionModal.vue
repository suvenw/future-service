    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="排序">
          <a-input-number placeholder="请输入菜单排序" style="width: 200px" v-decorator="[ 'sort',validatorRules.sort]" :readOnly="disableSubmit"/>
        </a-form-item>
  ...
  export default {
    ...
    computed:{
      validatorRules:function() {
        return {
          ...
          sort:{initialValue:1.0,rules: [{validator: this.validateNumber}]},
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.loadTree();
        let fieldsVal = pick(this.model,'name','perms','permsType','component','url','sort','menuType','status');
        this.$nextTick(() => {
