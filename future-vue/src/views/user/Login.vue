      ...
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          ...
          <a-row :gutter="0">
            ...
            <a-col  :span="10">
              <j-graphic-code @success="generateCode" ref="jgraphicCodeRef" style="float: right"></j-graphic-code>
            </a-col>
          </a-row>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        if (that.customActiveKey === 'tab1') {
          that.form.validateFields([ 'username', 'password','inputCode' ], { force: true }, (err, values) => {
            if (!err) {
              ...
              loginParams.password = this.encryption(values.password,'hAw6eqnFLKxpsDv3','hAw6eqnFLKxpsDv3')
      ...
      departConfirm(res){
        if(res.code == 0){
          let multi_depart = res.data.multi_depart
          //0:无部门 1:一个部门 2:多个部门
          if(multi_depart==0){
            this.loginSuccess()
