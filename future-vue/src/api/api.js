...
const modifyRole = (params)=>postAction("/sys/role/modify",params);
...
const mutedBatch = (params)=>postAction("/sys/user/mutedBatch",params);
//验证用户是否存在
...
const getPermissionList = (params)=>getAction("/sys/permission/getSystemMenuList",params);
