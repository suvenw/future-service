...
//	public void pcLogin( OutputSystem  out, SysUserLoginRequestVo sysLoginModel){
...
//        if(captcha == null){
//
//			out.write(SystemMsgCodeEnum.SYS_ERROR_500, SystemParamConstant.Sys.SYS_CAPTCHA_CODE_ERROR);
//            return ;
//        }
...
//		SysUser sysUser = sysUserService.getSysUserByOne(queryWrapper);
